...
export const ConstValue = {
    ...
    USER_HOTKEYS: `${PREFIX}userHotkeys`
};
export class UserConstValue {
    static get USER_PREFIX() {
        return `${PREFIX}${getStorage(ConstValue.CURRENT_USER)?.user?.username}-`;
    }
    ...
    static get FLOW_LEGEND_VISIBILITY() {
        return `${this.USER_PREFIX}flowLegendVisibility`
    }
    static get USER_HOTKEYS() {
        return `${this.USER_PREFIX}userHotkeys`
    }
}
